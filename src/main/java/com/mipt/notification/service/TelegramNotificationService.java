...
public class TelegramNotificationService {
    ...
    public void sendMessage(String receiverKey, String message) {
        ...
        if (chatId == null) {
            log.warn("Telegram chat id is not resolved for receiver: {}. Skip sending.",
                    receiverKey);
            return;
        }
    ...
    /**
     * Определение chatId по receiverKey Приоритет: 1. Зарегистрированные пользователи (userId из
     * системы) 2. Маппинг из конфигурации (chat-id-map) 3. Default chat id из конфигурации
     */
